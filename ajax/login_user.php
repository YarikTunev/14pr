...
if(!isset($_POST['login']) || !isset($_POST['password'])) exit("wrong");
...
if ($user_data) {
    $query_auth = $mysqli->query("SELECT id FROM `users` WHERE `login`='$login' AND `password`='$password'");
    $auth_data = $query_auth->fetch_row();

...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 03 2026 г., 21:26
...
INSERT INTO `users` (`id`, `login`, `password`, `roll`, `attempts`, `last_attempt`, `secret_question`, `secret_answer`) VALUES
(1, 'admin', 'Asdfg123', 1, 0, NULL, NULL, NULL),
(8, 'user', 'Asdfg123', 0, 0, NULL, NULL, NULL),
(24, 'test', 'test', 0, 0, NULL, NULL, NULL),
(33, 'test23', 'test23', 0, 0, NULL, 'Имя кошки', 'тушка');

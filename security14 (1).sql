...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 09 2026 г., 22:00
...
INSERT INTO `users` (`id`, `login`, `password`, `roll`, `last_attempt`, `secret_question`, `secret_answer`) VALUES
(1, 'admin', 'Asdfg123', 1, NULL, NULL, NULL),
(8, 'user', 'Asdfg123', 0, NULL, NULL, NULL),
(24, 'test', 'test', 0, NULL, 'test', 'test'),
(33, 'test23', 'test23', 0, NULL, 'Имя кошки', 'тушка');
...
--
ALTER TABLE `comments`
  MODIFY `Id` int NOT NULL AUTO_INCREMENT COMMENT 'Код', AUTO_INCREMENT=19;
